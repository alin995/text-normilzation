...
// 字母和对应的unicode十进制编码的字典：
// {97: 65345, 98: 65346, 99: 65347, 100: 65348, 101: 65349, 102: 65350, 103: 65351, 104: 65352, 105: 65353, 106: 65354, 107: 65355, 108: 65356, 109: 65357, 110: 65358, 111: 65359, 112: 65360, 113: 65361, 114: 65362, 115: 65363, 116: 65364, 117: 65365, 118: 65366, 119: 65367, 120: 65368, 121: 65369, 122: 65370, 65: 65313, 66: 65314, 67: 65315, 68: 65316, 69: 65317, 70: 65318, 71: 65319, 72: 65320, 73: 65321, 74: 65322, 75: 65323, 76: 65324, 77: 65325, 78: 65326, 79: 65327, 80: 65328, 81: 65329, 82: 65330, 83: 65331, 84: 65332, 85: 65333, 86: 65334, 87: 65335, 88: 65336, 89: 65337, 90: 65338}
// 这个字典将小写字母和大写字母分别对应了一组连续的unicode编码。s
export const F2H_ASCII_LETTERS = {
    'a': 'ﭐ',
    'b': 'ﭑ',
    'c': 'ﭒ',
    'd': 'ﭓ',
...
export const replaceDate2 = (match:string):string => {
    ...
    let result = '';
    if (year) {
        result += `${verbalizeDigit02(year)}年`;
    }
    if (month) {
        result += `${verbalizeDigit02(month)}月`;
    }
    if (day) {
        result += `${verbalizeDigit02(day)}${match[9]}`;
    }
    console.log(result)
    return result;
}
...
const _getValue:(valueString:string)  =>string[] = (valueString:string):string[] => {
    ...
    for (let i = 0; i < valueString.length; i++) {
        ...
        if (digitSymbol === '零') {
            if (resultSymbols.length === 0 || resultSymbols[resultSymbols.length - 1] === '零') {
                continue;
            }
        }
        resultSymbols.push(digitSymbol);
        if (unit !== '') {
...
export const num2str = (valueString:string):string  => {
    ...
    if (decimal) {
        ...
        if (trimmedDecimal) {
            result = result || '零';
            result += `点${verbalizeDigit(trimmedDecimal)}`;
...
export const  replaceTemperature = (str:string):string  => {
    ...
    return str.replace(RE_TEMPERATURE, (match, sign, temperature, _, unit) => {
        ...
        unit = unit === "摄氏度" || unit === "℃" || unit === "°C" ? "摄氏度" : "度";
...
export const replace_range = (match:string):string => {
    ...
    second = second.replace(RE_NUMBER, replace_number);
...
export const replace_number = (match:string):string => {
    ...
    // const pure_decimal = match[5];
    const pure_decimal = match;
    let result;
    if (pure_decimal) {
        result = num2str(pure_decimal);
    } else {
        const sign_str = sign ? "负" : "";
        const number_str = num2str(number);
        result = `${sign_str}${number_str}`;
    }
    return result;
}
